...
def choose_graph_algorithm(adj_list, algo="auto"):
    ...
    if algo == "auto":
        ...
        if weighted:
            result["output"]["dijkstra_heap"] = dijkstra_heap(copy.deepcopy(weighted_adj_list), 0)
            result["output"]["dijkstra_matrix"] = dijkstra_matrix(copy.deepcopy(weighted_adj_list), 0)
        return result
    else:
